...
void __init vps_fvid2_capt_ctrl_init(struct vps_capt_ctrl *cctrl)
{
	...
	cctrl->ccparams->videoIfMode = VPS_CAPT_VIDEO_IF_MODE_24BIT;
	cctrl->ccparams->inDataFormat = FVID2_DF_RGB24_888;
	...
	cctrl->ccparams->outStreamInfo[0].dataFormat  = FVID2_DF_RGBA32_8888;
	cctrl->ccparams->outStreamInfo[0].memType = VPS_VPDMA_MT_NONTILEDMEM;
	cctrl->ccparams->outStreamInfo[0].pitch[0] = 720*4;
	cctrl->ccparams->outStreamInfo[0].maxOutHeight =
		VPS_CAPT_MAX_OUT_HEIGHT_576_LINES;
	...
	cctrl->decoder_width = 720;
	cctrl->decoder_width = 576;
	cctrl->scformat = FVID2_SF_PROGRESSIVE;

	cctrl->fmt.channelnum = 0;
	cctrl->fmt.width = 720;
	cctrl->fmt.height = 576;
	cctrl->fmt.pitch[0] = 720 * 4;
	cctrl->fmt.pitch[1] = 720 * 4;
	cctrl->fmt.pitch[2] = 720 * 4;

	cctrl->fmt.fieldmerged[0] = 0;
	cctrl->fmt.fieldmerged[1] = 0;
	cctrl->fmt.fieldmerged[2] = 0;

	cctrl->fmt.dataformat = FVID2_DF_RGBA32_8888;
